...
public class TestPost extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final String review ="Hi, I'm uisng Feeling.ly for Android. Its an awesome app. I think you must give it a try!!!";
...
/*		if (mFacebook.isSessionValid()) {
	...
	private void postToFacebook(String review) {	
		...
		params.putString("name", "Feeling.ly");
		params.putString("caption", "Feeling.ly : An Android app for the hearing impaired");
	//	params.putString("link", "http://www.londatiga.net");
		params.putString("description", "Jaseem Abbas likes Feeling.ly");
